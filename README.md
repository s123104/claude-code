...
| 專案文件                                                                   | 專案描述                 | 版本   | 最後更新   | 主要功能                   | 獨立性 |
| -------------------------------------------------------------------------- | ------------------------ | ------ | ---------- | -------------------------- | ------ |
| [🤖 agents-zh-tw.md](docs/agents-zh-tw.md)                                 | 99 個專業子代理集合      | v3.0.0 | 2025-12-23 | 99 代理、66 插件、107 技能 | ⭐⭐⭐ |
| [🤖 contains-studio-agents-zh-tw.md](docs/contains-studio-agents-zh-tw.md) | 37+ 專業代理（6 天衝刺） | v1.2   | 2025-07-28 | 37+ 代理、7 部門、自動觸發 | ⭐⭐⭐ |

#### 適用客群與應用場景（AI 代理類）

- **Agents（99 子代理）**：功能：99 個專業代理、66 個插件、107 個技能、領域專家子代理與智能分工；應用場景：大型專案的多角色協作、按任務自動選用代理；適用客群：產品/工程團隊、專案負責人
...
| 專案文件                                     | 專案描述         | 版本    | 最後更新   | 主要功能                             | 獨立性 |
| -------------------------------------------- | ---------------- | ------- | ---------- | ------------------------------------ | ------ |
| [⚡ ccusage-zh-tw.md](docs/ccusage-zh-tw.md) | 極速用量分析工具 | v17.2.0 | 2025-12-22 | 極速分析、狀態列整合、5 小時區塊報告 | ⭐⭐⭐ |

#### 適用客群與應用場景（監控分析類）

- **ccusage (v17.2.0)**：功能：極速 CLI 分析、Statusline 狀態列、5 小時區塊報告、即時監控、報表匯出；應用場景：本地開發成本檢視、CI 產出報告、即時用量追蹤；適用客群：日常開發者、資料分析/報表維護
...
| 專案文件                                               | 專案描述          | 版本     | 最後更新   | 主要功能                        | 獨立性 |
| ------------------------------------------------------ | ----------------- | -------- | ---------- | ------------------------------- | ------ |
| [🖥️ claudecodeui-zh-tw.md](docs/claudecodeui-zh-tw.md) | Web UI 管理介面   | v1.12.0  | 2025-12-17 | PWA 支援、雙 CLI、TaskMaster AI | ⭐⭐⭐ |
| [🖥️ opcode-zh-tw.md](docs/opcode-zh-tw.md)             | 桌面 GUI (opcode) | v0.2.2+  | 2025-10-16 | 桌面應用、會話管理、視覺化      | ⭐⭐⭐ |
| [📋 vibe-kanban-zh-tw.md](docs/vibe-kanban-zh-tw.md)   | 看板專案管理      | v0.0.142 | 2025-12-22 | Git 整合、10 代理、多代理協作   | ⭐⭐⭐ |
...
- **opcode (v0.2.2+)**：功能：桌面 GUI 應用、會話管理、視覺化、Tauri 2 框架；應用場景：圖形化專案管理、視覺化監控；適用客群：開發者、PM、設計師
- **Vibe Kanban (v0.0.142)**：功能：看板管理、Git 整合、10 個程式設計代理、MCP 伺服器整合、遠端 SSH 配置；應用場景：專案管理、團隊協作、多代理協作管理；適用客群：專案經理、敏捷團隊
...
| 專案文件                                                         | 專案描述      | 版本   | 最後更新   | 主要功能              | 獨立性 |
| ---------------------------------------------------------------- | ------------- | ------ | ---------- | --------------------- | ------ |
| [📖 claude-code-guide-zh-tw.md](docs/claude-code-guide-zh-tw.md) | 基礎 API 指南 | v1.5   | 2025-12-23 | CLI 操作、基礎設定    | ⭐⭐   |
...
> 📝 **注意**：Claude Code Hooks 指南已歸檔（2025-12-24），建議參考[官方 Hooks 文檔](/docs/anthropic-claude-code-zh-tw/hooks.md)
...
- [ryoppippi/ccusage](https://github.com/ryoppippi/ccusage) - 用量分析（推薦）
...
- [RchGrav/claudebox](https://github.com/RchGrav/claudebox) - Docker 容器化
- [ryoppippi/ccusage](https://github.com/ryoppippi/ccusage) - 用量分析
- [KentBeck/BPlusTree3](https://github.com/KentBeck/BPlusTree3) - 效能優化資料結構
...
_最後更新：2025-12-25T01:43:00+08:00 | 語言：繁體中文 | 資料來源：Anthropic 官方文件與社群專案_
